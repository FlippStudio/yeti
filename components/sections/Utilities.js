          ...
          <Box>
            ...
            <Box className="flex-center">
              <Typography component="div" className={classes.utiDesc}>
                ...
                it's a ticket to access exclusive utilities and perks, obtain a
                whitelist for other NFT projects, and it will be used as genesis
                characters in our upcoming game. The first semi-idle.
                <br />
                <br />
